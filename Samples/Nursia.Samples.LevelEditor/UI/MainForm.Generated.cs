/* Generated by MyraPad at 9/5/2023 3:09:27 PM */
using Myra;
...
namespace Nursia.Samples.LevelEditor.UI
{
	partial class MainForm: VerticalStackPanel
	{
		private void BuildUI()
		{
			...
			_gridTerrainLibrary.RowsProportions.Add(new Proportion
			{
			...
			_sliderTerrainPower.Minimum = 1;
			_sliderTerrainPower.Maximum = 10;
			_sliderTerrainPower.Value = 2;
