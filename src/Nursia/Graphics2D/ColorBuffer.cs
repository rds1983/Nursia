...
namespace Nursia.Graphics2D
{
	...
	public class ColorBuffer
	{
		...
		/// <summary>
		/// Constructs a <see cref="ColorBuffer"/> of the specified size
		/// </summary>
		...
		/// <summary>
		/// Constructs a <see cref="ColorBuffer"/> of the specified size and containing specified data
		/// </summary>
		/// <param name="width"></param>
		/// <param name="height"></param>
		...
		{
			var texture = new Texture2D(Nrs.GraphicsDevice, Width, Height, false, SurfaceFormat.Color);
		...
		/// <returns></returns>
		public static unsafe ColorBuffer FromStream(Stream stream)
		{
			byte[] bytes;
